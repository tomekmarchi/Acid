(function () {
	...
	$.model('core', function () {
		...
		var parent = $.reactModel('parent', {
			...
			template: '<div><b>Change Text</b><input placeholder="Shared Text" data-node="input" data-keyup="this.onChange"></div>'
		});
		...
		var child = $.reactModel('child', {
			...
			template: '<div><h3 data-node="title">Title</h3><input placeholder="Title" data-keyup="this.onChange" /> <p data-node="text" class="pad_box">TEXT</p></div>'
		});
		for (var i = 0; i < 4; i++) {
